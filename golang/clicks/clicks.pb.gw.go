...
var (
	filter_UrlClicks_Redirect_0 = &utilities.DoubleArray{Encoding: map[string]int{"shortUrl": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_UrlClicks_Redirect_0(ctx context.Context, marshaler runtime.Marshaler, client UrlClicksClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_UrlClicks_Redirect_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_UrlClicks_Redirect_0(ctx context.Context, marshaler runtime.Marshaler, server UrlClicksServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UrlClickRequest
	var metadata runtime.ServerMetadata
...
func RegisterUrlClicksHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UrlClicksServer) error {
	...
	mux.Handle("GET", pattern_UrlClicks_Redirect_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.UrlClicks/Redirect", runtime.WithHTTPPathPattern("/api/v1/url/get/{shortUrl}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_UrlClicks_Redirect_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_UrlClicks_Redirect_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterUrlClicksHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UrlClicksClient) error {
	...
	mux.Handle("GET", pattern_UrlClicks_Redirect_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.UrlClicks/Redirect", runtime.WithHTTPPathPattern("/api/v1/url/get/{shortUrl}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UrlClicks_Redirect_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_UrlClicks_Redirect_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "v1", "url", "get", "shortUrl"}, ""))
)

var (
	forward_UrlClicks_Redirect_0 = runtime.ForwardResponseMessage
)
